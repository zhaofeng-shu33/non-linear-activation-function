...
Below we use some approximation $n, k >> 1$ and $ t << k$. Without these two assumptions we can compute $N_{ij} = \prod_{i=0}^{t-1} \frac{(2i+1)(2i+k)}{(2i+n)^2}$ when $i+j = 2t$; otherwise $N_{ij}=0$.

...
\end{align*}
If we have an integral over all $2\times 2$ positive definite matrices, we can convert the integral to $\theta, \lambda_1, \lambda_2$. The determinant of the Jacobi matrix is $2\abs{\lambda_1 - \lambda_2}(\sin^4 \theta + \cos^4 \theta)$

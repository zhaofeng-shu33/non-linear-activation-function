...
\maketitle
\section{Abstract}
We find under orthogonal feature (which can be obtained by PCA techniques etc.), using Hermite orthogonal polynomial as activation function is universally good. 
\section{Background}
...
Average over $A_{11}, A^2_{12}(\approx r' = \frac{k}{n^2}),
...
Therefore the order of $n$ in second term is smaller than

...
The multivariate Beta function is used as a distribution for sub-blocks of $A=X'X'^T$ where $X'$ is $n \times k$ sub-matrix of random orthogonal matrix $X$. From Proposition 7.2 of \cite{eaton1989group} we conclude that the distribution for $2\times 2$ upper matrix of $A$ is 
\begin{equation}
